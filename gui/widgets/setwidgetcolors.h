...
public:
    ...
    Glib::RefPtr<Gtk::StyleContext> getPlainButtonStyle();

private:
    Gdk::RGBA m_Button_BgColorActive, m_Button_BgColorInactive, m_Button_BgColorNormal,
        m_Button_BgColorOver, m_Button_FgColor, m_Button_TextColor;
    Gdk::RGBA m_BandsColors[10]; 
	Glib::RefPtr<Gtk::StyleContext> PlainButtonStyle;
};
