...
static LV2UI_Handle instantiateDyn_gui(const LV2UI_Descriptor *descriptor, const char *plugin_uri,
    ...
    DynMainWindow *gui_data = new DynMainWindow(plugin_uri, std::string(bundle_path), sTitle,
                                                bIsCompressor, bHasSideChain);
...
static void portEventDyn_gui(LV2UI_Handle ui, uint32_t port_index, uint32_t buffer_size,
                             uint32_t format, const void *buffer) {
#ifdef TESTING_EQ10Q
    cout << "portEventEq10q_gui Entring... "
...
static const LV2UI_Descriptor dyn_guiDescriptor = {DYNAMICS_GUI_URI, instantiateDyn_gui,
                                                   cleanupDyn_gui, portEventDyn_gui, NULL};
