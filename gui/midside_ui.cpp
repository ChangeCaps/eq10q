...
static LV2UI_Handle instantiateMidSide_gui(const LV2UI_Descriptor *descriptor,
    ...
    MidSideMainWindow *gui_data =
        new MidSideMainWindow(plugin_uri, std::string(bundle_path), bIsLR2MS);
...
static void portEventMidSide_gui(LV2UI_Handle ui, uint32_t port_index, uint32_t buffer_size,
...
static const LV2UI_Descriptor MidSide_guiDescriptor = {
    MIDSIDEMAT_GUI_URI, instantiateMidSide_gui, cleanupMidSide_gui, portEventMidSide_gui, NULL};
